const FacilityDetails = () => {
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-base text-black-200 font-be-vietnam-pro">
      ...
      <div className="absolute top-[391px] left-[302px] rounded-xxs bg-mediumblue w-[106px] h-[23px]" />
      ...
      <div className="absolute top-[360px] left-[302px] leading-[84px] font-black font-normal11 text-white text-center inline-block w-[115px] h-[85px]">
        Book Now
      </div>
    </div>
  );
