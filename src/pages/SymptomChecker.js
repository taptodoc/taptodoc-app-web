...
const SymptomChecker = () => {
  ...
  const onTreatmentIcon1Click = useCallback(() => {
    navigate("/find-treatment");
  }, [navigate]);

  const onPatientIcon1Click = useCallback(() => {
    navigate("/find-treatment");
  }, [navigate]);

  const onFacilityIcon1Click = useCallback(() => {
  ...
  return (
    <div className="relative bg-gray-100 w-full h-[1325px] text-center text-5xl text-black-200 font-text-xs-regular">
      <div className="absolute top-[0px] left-[0px] bg-white w-[1440px] h-[1325px] overflow-hidden text-gray-200">
        <img
          className="absolute top-[982px] left-[300px] rounded-[140.31px] w-[50.51px] h-[50.51px] overflow-hidden"
          alt=""
        ...
        <div className="absolute w-[11.81%] top-[24px] right-[1.39%] left-[86.81%] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] h-16 overflow-hidden text-white font-radio-canada">
          ...
          <img
            className="absolute top-[calc(50%_-_20px)] right-[6px] w-10 h-10 hidden"
            alt=""
            src="../iconarrow-right.svg"
          />
          <img
            className="absolute top-[calc(50%_-_20px)] left-[6px] w-10 h-10 hidden"
            alt=""
        ...
        <button
          className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[24px] left-[9px] w-[176.41px] h-10 bg-[url(../public/logo@2x.png)] bg-cover bg-no-repeat bg-[top]"
        ...
        <div className="absolute top-[495px] left-[34px] w-[47px] h-[341px]">
          <button
            className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[0px] left-[2px] w-10 h-[42px] bg-[url(../public/treatmenticon1@3x.png)] bg-cover bg-no-repeat bg-[top] hover:animate-[1s_ease_0s_infinite_normal_none_scale-up] hover:opacity-[1]"
            onClick={onTreatmentIcon1Click}
          />
          <button
            className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[142px] left-[0px] w-[42px] h-[43px] bg-[url(../public/patienticon1@3x.png)] bg-cover bg-no-repeat bg-[top] hover:animate-[1s_ease_0s_infinite_normal_none_scale-up] hover:opacity-[1]"
            onClick={onPatientIcon1Click}
          />
          <button
            className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[296px] left-[4px] w-[43px] h-[45px] bg-[url(../public/facilityicon1@3x.png)] bg-cover bg-no-repeat bg-[top] hover:animate-[1s_ease_0s_infinite_normal_none_scale-up] hover:opacity-[1]"
            onClick={onFacilityIcon1Click}
          />
        </div>
        <img
        ...
        <div className="absolute top-[681.5px] left-[442.5px] rounded-base bg-white shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] box-border w-[589px] h-[60px] border-[0.5px] border-solid border-black-black-50">
          ...
          />
          <button
            className="cursor-pointer [border:none] p-0 bg-[transparent] absolute top-[5px] left-[539px] w-[49px] h-[49px] bg-[url(../public/search-1@2x.png)] bg-cover bg-no-repeat bg-[top] [&.animate]:animate-[1s_ease_0s_1_normal_forwards_scale-up] opacity-[1]"
